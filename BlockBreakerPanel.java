...
public class BlockBreakerPanel extends JPanel implements KeyListener {
	...
	BlockBreakerPanel(){
		...
		//randomly select a block that has a power up
		...
		//need these next 2 lines to read the keys
		addKeyListener(this);
		setFocusable(true);
	}
	...
	public void paintComponent(Graphics g){
		//this erases the screen and repaints whatever we call 
	...
	public void update(){
		//this drops a powerup each time there is an update 
		for(Block p: powerup){
			p.y+=1;
	...
	// moving paddle from left to right 
